...
window.__MOVIES__ = {
  ...
  "movies": [
      ...
      "bonuses": [
        {
          "phase": "第5弾",
          "period": "9/19(土)〜",
          "content": "全52ページの「ひみつ本」（描き下ろし漫画・エッセイ、セイレーン編構想時のストーリーイラストなど収録）",
          "limited": true,
          "note": "劇場ごとに数量限定、なくなり次第配布終了"
        }
      ],
      "bonusNote": "",
      "theaters": [],
    ...
    },
    {
      ...
      "bonuses": [
        ...
        },
        {
          ...
          "content": "はなまる発見★チェンジングカード（「名探偵プリキュア!」「キミとアイドルプリキュア♪」「わんだふるぷりきゅあ!」の全3種からランダム1点、動かすと絵柄がチェンジ）",
          "limited": true,
          "note": "1週間限定・数量限定。第1弾と異なり大人も入手可能"
        }
      ],
      "bonusNote": "",
    ...
    },
    {
      ...
      "releaseLabel": "2026年7月3日(金)公開",
      "rating": "G",
      "runtime": 102,
      "genre": "アニメ・ファミリー",
      "dubbed": true,
      "synopsis": "想像力豊かで内気な少女・ボニーの成長をそばで見守ってきたカウガール人形のジェシー。しかしタブレット端末「リリーパッド」の登場で日常は大きく変わり、ウッディやバズと共に新たなハイテクおもちゃたちとの騒動に巻き込まれていく。",
      "posterUrl": "https://image.tmdb.org/t/p/w500/dEoN5k2ulqk9mhEwVrapciKJm8s.jpg",
      "tmdbId": 1084244,
      "mubichike": {
        "available": false,
        "salesLabel": "",
      ...
      "bonuses": [
        {
          "phase": "トイ・ストーリー30周年記念",
          "period": "9/12(金)〜",
          "content": "30周年記念ビジュアル＆『トイ・ストーリー5』特別ビジュアル ポストカードセット",
          "limited": true,
          "note": "一部劇場を除く、なくなり次第配布終了"
        }
      ],
      "bonusNote": "",
      "theaters": ["T・ジョイ横浜", "イオンシネマ みなとみらい"],
    ...
    },
    {
      ...
      "genre": "邦画・ドラマ",
      "dubbed": false,
      "synopsis": "学級新聞に4コマ漫画を連載する小学4年生の藤野は、不登校の同級生・京本の圧倒的な画力に出会い衝撃を受ける。二人はやがて漫画家を志し、ライバルであり創作の仲間として歩みを共にしていく。藤本タツキ原作、是枝裕和監督による実写映画化。",
      "posterUrl": "https://image.tmdb.org/t/p/w500/6eXDHPwPDTZTgf4wuGIP49bxxJV.jpg",
      "tmdbId": 1591675,
      "mubichike": {
        "available": false,
        "salesLabel": "",
      ...
      "bonuses": [
        {
          "phase": "第2弾",
          "period": "9/18(金)〜",
          "content": "全64ページの特別小冊子「Special Booklet Volume1」（劇中作「メタルパレード」完成版41ページ、藤本タツキ×是枝裕和ら対談を収録）",
          "limited": true,
          "note": "なくなり次第配布終了"
        }
      ],
    ...
    },
    {
      ...
      "genre": "邦画・ドラマ",
      "dubbed": false,
      "synopsis": "瀬戸内のとある島で高校時代に出会った、漫画家を夢見る青埜櫂と刺繍の仕事を志す井上暁海。本屋大賞受賞のベストセラー小説を原作に、15年にわたる2人の切ない愛と選択を描く。横浜流星×広瀬すずW主演。",
      "posterUrl": "https://image.tmdb.org/t/p/w500/nRoVOvMPOEM9GuHu5FKGigbXzVT.jpg",
      "tmdbId": 1590933,
      "mubichike": {
        "available": true,
